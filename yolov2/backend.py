...
FULL_YOLO_BACKEND_PATH  = "yolov2/full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = "yolov2/tiny_yolo_backend.h5"   # should be hosted on a server
