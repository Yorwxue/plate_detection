...
from yolov2.preprocessing import BatchGenerator
from keras.callbacks import EarlyStopping, ModelCheckpoint, TensorBoard
from yolov2.utils import BoundBox
from yolov2.backend import TinyYoloFeature, FullYoloFeature, MobileNetFeature, SqueezeNetFeature, Inception3Feature, VGG16Feature, ResNet50Feature
            ...
            for col in range(grid_w):
                for b in range(nb_box):
                    ...
                    if np.sum(classes) > 0:
                        ...
                        if w >= 0.1 and h >= 0.1 and confidence > 0.4 and classes[1] == 0.0:
                        #if w >= 0.1 and h >= 0.1 and confidence > 0.5 :
                            boxes.append(box)
